...
public class Day6 {
    ...
    private void STYLE_CHOICE_BUTTON(JButton B) {
      ...
      private void BUILD_STORY() {
        ...
        SCENES.put("S2", new SCENE("Narrator", "Day6", "เช้าวันนี้อากาศสดใสกว่าทุกวัน", null, null, null, "S3", null, null, null));
        SCENES.put("S3", new SCENE("Narrator", "Day6", "แสงแดดอ่อน ๆ ลอดผ่านผ้าม่านเข้ามา", null, null, null, "S4", null, null, null));
        SCENES.put("S4", new SCENE("Narrator", "Day6", "โทรศัพท์ของคุณสั่น", null, null, null, "S5", null, null, null));
        SCENES.put("S5", new SCENE("Narrator", "Day6", "ข้อความจากเขา", null, null, null, "S6", null, null, null));
        SCENES.put("S6", new SCENE("Kim Jae-hyun", "Day6", "“ตื่นยัง”", null, null, null, "S7", null, null, null));
        SCENES.put("S7", new SCENE("Kim Jae-hyun", "Day6", "“วันนี้ว่างไหม…”", null, null, null, "S8", null, null, null));
        SCENES.put("S8", new SCENE("Kim Jae-hyun", "Day6", "“อยากชวนไปเที่ยวด้วยกันหน่อย”", null, null, null, "S9", null, null, null));
        SCENES.put("S9", new SCENE("Narrator", "Day6", "คุณอ่านวนซ้ำสองรอบ ใจเต้นเร็วขึ้นโดยไม่รู้ตัว", null, null, null, "S10", null, null, null));
        SCENES.put("S10", new SCENE("Narrator", "Day6", "คำว่า “ไปเที่ยวด้วยกัน” มันไม่ใช่แค่คำธรรมดา", null, null, null, "S11", null, null, null));
        SCENES.put("S11", new SCENE("Narrator", "Day6", "คุณพิมพ์ตอบตกลง แม้มือจะสั่นเล็กน้อย", null, null, null, "S12", null, null, null));
        SCENES.put("S12", new SCENE("Kim Jae-hyun", "Day6", "“งั้นบ่ายสอง เจอกันหน้าสถานีรถไฟนะ :)”", null, null, null, "S13", null, null, null));
        SCENES.put("S13", new SCENE("Narrator", "Day6", "คุณเผลอยิ้มให้หน้าจอ", null, null, null, "S14", null, null, null));

        SCENES.put("S14", new SCENE("Narrator", "Day6", "ฉากที่ 1 — เจอกันครั้งแรกของวันนี้", null, null, null, "S15", null, null, null));
        SCENES.put("S15", new SCENE("Narrator", "Day6", "ตอนคุณเดินไปถึง เขายืนพิงเสาอยู่ก่อนแล้ว", null, null, null, "S16", null, null, null));
        SCENES.put("S16", new SCENE("Narrator", "Day6", "ใส่เสื้อที่คุณเคยชมว่าสีนี้เหมาะกับเขา", null, null, null, "S17", null, null, null));
        SCENES.put("S17", new SCENE("Narrator", "Day6", "พอเขาเห็นคุณ รอยยิ้มก็ปรากฏทันที", null, null, null, "S18", null, null, null));
        SCENES.put("S18", new SCENE("Kim Jae-hyun", "Day6", "“วันนี้…ดูดีนะ”", null, null, null, "S19", null, null, null));
        SCENES.put("S19", new SCENE("Narrator", "Day6", "หัวใจคุณสะดุด", null, null, null, "Q1", null, null, null));
        ...
        SCENES.put("Q1_A", new SCENE("คุณ", "Day6", "“ก็ต้องดูดีหน่อยสิ มากับเธอนี่นา”", null, null, null, "S20", null, null, null));
        SCENES.put("Q1_B", new SCENE("คุณ", "Day6", "“จริงเหรอ ขอบคุณนะ”", null, null, null, "S20", null, null, null));
        SCENES.put("Q1_C", new SCENE("คุณ", "Day6", "“ปกติแหละ”", null, null, null, "S20", null, null, null));

        SCENES.put("S20", new SCENE("Narrator", "Day6", "ฉากที่ 2 — เดินเล่นในสวนสนุก", null, null, null, "S21", null, null, null));
        SCENES.put("S21", new SCENE("Narrator", "Day6", "เสียงเพลงสดใสลอยตามลม กลิ่นขนมหวานลอยมาแตะปลายจมูก", null, null, null, "S22", null, null, null));
        SCENES.put("S22", new SCENE("Narrator", "Day6", "คุณสองคนเดินช้า ๆ ไหล่แทบจะชนกัน", null, null, null, "S23", null, null, null));
        SCENES.put("S23", new SCENE("Narrator", "Day6", "บางจังหวะมือเกือบแตะ แต่ก็ไม่มีใครกล้าขยับ", null, null, null, "S24", null, null, null));
        SCENES.put("S24", new SCENE("Kim Jae-hyun", "Day6", "“อยากเล่นอะไรไหม”", null, null, null, "S25", null, null, null));
        SCENES.put("S25", new SCENE("Narrator", "Day6", "คุณชี้ไปที่ชิงช้าสวรรค์ มันสูงมาก แต่ก็โรแมนติกมากเหมือนกัน", null, null, null, "S26", null, null, null));
        SCENES.put("S26", new SCENE("Kim Jae-hyun", "Day6", "เขายิ้มบาง ๆ “กลัวความสูงไหม”", null, null, null, "Q2", null, null, null));
        ...
        SCENES.put("S27", new SCENE("Narrator", "Day6", "บนชิงช้าสวรรค์", null, null, null, "S28", null, null, null));
        SCENES.put("S28", new SCENE("Narrator", "Day6", "กระเช้าค่อย ๆ ลอยสูงขึ้น เมืองทั้งเมืองค่อย ๆ เล็กลง", null, null, null, "S29", null, null, null));
        SCENES.put("S29", new SCENE("Narrator", "Day6", "ภายในเงียบลงทันที มีแค่เสียงลมหายใจของคุณสองคน", null, null, null, "S30", null, null, null));
        SCENES.put("S30", new SCENE("Narrator", "Day6", "ระยะห่างแค่เอื้อมมือก็ถึง", null, null, null, "S31", null, null, null));
        SCENES.put("S31", new SCENE("Narrator", "Day6", "ตอนกระเช้าหยุดอยู่จุดสูงสุด ลมพัดแรงเล็กน้อย", null, null, null, "S32", null, null, null));
        SCENES.put("S32", new SCENE("Narrator", "Day6", "ตัวคุณเอนนิดหนึ่งโดยไม่ตั้งใจ", null, null, null, "S33", null, null, null));
        SCENES.put("S33", new SCENE("Narrator", "Day6", "เขาขยับเข้ามาใกล้ทันที", null, null, null, "S34", null, null, null));
        SCENES.put("S34", new SCENE("Kim Jae-hyun", "Day6", "“ระวังนะ”", null, null, null, "S35", null, null, null));
        SCENES.put("S35", new SCENE("Narrator", "Day6", "มือเขาแตะหลังมือคุณ แค่เบา ๆ แต่ไฟฟ้าเหมือนแล่นผ่านหัวใจ", null, null, null, "S36", null, null, null));
        SCENES.put("S36", new SCENE("Narrator", "Day6", "คุณเงยหน้าขึ้น สายตาสบกันพอดี", null, null, null, "S37", null, null, null));
        SCENES.put("S37", new SCENE("Narrator", "Day6", "โลกเหมือนเงียบไปหมด", null, null, null, "Q3", null, null, null));
        ...
        SCENES.put("S38", new SCENE("Narrator", "Day6", "ฉากที่ 3 — ช่วงเย็นริมแม่น้ำ", null, null, null, "S39", null, null, null));
        SCENES.put("S39", new SCENE("Narrator", "Day6", "หลังจากเดินเล่นมาทั้งวัน คุณสองคนไปนั่งที่ริมแม่น้ำ", null, null, null, "S40", null, null, null));
        SCENES.put("S40", new SCENE("Narrator", "Day6", "พระอาทิตย์กำลังตก ท้องฟ้าเปลี่ยนเป็นสีส้มชมพู", null, null, null, "S41", null, null, null));
        SCENES.put("S41", new SCENE("Narrator", "Day6", "ลมเย็นพัดผมคุณปลิว", null, null, null, "S42", null, null, null));
        SCENES.put("S42", new SCENE("Narrator", "Day6", "เขาเอื้อมมือมาจัดผมให้เบา ๆ", null, null, null, "S43", null, null, null));
        SCENES.put("S43", new SCENE("Kim Jae-hyun", "Day6", "“เดี๋ยวเข้าตา”", null, null, null, "S44", null, null, null));
        SCENES.put("S44", new SCENE("Narrator", "Day6", "สัมผัสนั้นนุ่มนวลมาก ใกล้จนคุณได้ยินเสียงหัวใจเขา", null, null, null, "S45", null, null, null));
        SCENES.put("S45", new SCENE("Narrator", "Day6", "เงียบไปครู่หนึ่ง", null, null, null, "S46", null, null, null));
        SCENES.put("S46", new SCENE("Kim Jae-hyun", "Day6", "“เราดีใจนะที่วันนี้เธอมาด้วย”", null, null, null, "S47", null, null, null));
        SCENES.put("S47", new SCENE("Narrator", "Day6", "เสียงเขาจริงใจกว่าทุกครั้ง", null, null, null, "S48", null, null, null));
        SCENES.put("S48", new SCENE("Kim Jae-hyun", "Day6", "“ช่วงนี้…เราคิดถึงเธอบ่อยมากเลย”", null, null, null, "S49", null, null, null));
        SCENES.put("S49", new SCENE("Narrator", "Day6", "หัวใจคุณเต้นแรงจนแทบควบคุมไม่อยู่", null, null, null, "Q4", null, null, null));
        ...
        SCENES.put("Q4_A", new SCENE("คุณ", "Day6", "“เราก็คิดถึงเธอเหมือนกัน”", null, null, null, "S50", null, null, null));
        ...
        SCENES.put("S50", new SCENE("Narrator", "Day6", "ฉากที่ 4 — เดินกลับตอนกลางคืน", null, null, null, "S51", null, null, null));
        SCENES.put("S51", new SCENE("Narrator", "Day6", "ไฟถนนเปิดสว่าง ผู้คนบางตาลง", null, null, null, "S52", null, null, null));
        SCENES.put("S52", new SCENE("Narrator", "Day6", "มือของคุณกับเขาแกว่งไปมาใกล้กัน ใกล้จนแทบจะประสานกันได้", null, null, null, "S53", null, null, null));
        SCENES.put("S53", new SCENE("Narrator", "Day6", "จังหวะหนึ่ง มือชนกันจริง ๆ ไม่มีใครชักออก", null, null, null, "S54", null, null, null));
        SCENES.put("S54", new SCENE("Narrator", "Day6", "นิ้วก้อยแตะกัน ก่อนที่เขาจะกระซิบ", null, null, null, "S55", null, null, null));
        SCENES.put("S55", new SCENE("Kim Jae-hyun", "Day6", "“เราถามอะไรหน่อยได้ไหม”", null, null, null, "S56", null, null, null));
        SCENES.put("S56", new SCENE("Narrator", "Day6", "คุณหันไปมอง", null, null, null, "S57", null, null, null));
        SCENES.put("S57", new SCENE("Kim Jae-hyun", "Day6", "“ตอนนี้…เรากำลังจีบกันอยู่ใช่ไหม”", null, null, null, "Q5", null, null, null));
        ...
        SCENES.put("Q5_A", new SCENE("คุณ", "Day6", "“ใช่…แล้วเธอล่ะคิดว่าไง”", null, null, null, "S58", null, null, null));
        ...
        SCENES.put("S58", new SCENE("Narrator", "Day6", "เขาจะหยุดเดิน หันมาหาคุณตรง ๆ", null, null, null, "S59", null, null, null));
        SCENES.put("S59", new SCENE("Narrator", "Day6", "แสงไฟสะท้อนดวงตาเขา", null, null, null, "S60", null, null, null));
        SCENES.put("S60", new SCENE("Kim Jae-hyun", "Day6", "“งั้น…ให้เราได้จีบเธอแบบจริงจังเลยได้ไหม”", null, null, null, "S61", null, null, null));
        SCENES.put("S61", new SCENE("Narrator", "Day6", "มือเขายังจับมือคุณอยู่ อุ่นมาก มั่นคงมาก", null, null, null, "S62", null, null, null));
        SCENES.put("S62", new SCENE("Narrator", "Day6", "แต่ยังไม่เรียกว่าแฟน", null, null, null, "S63", null, null, null));
        SCENES.put("S63", new SCENE("Narrator", "Day6", "ทุกอย่างจะถูกตัดสิน ในวันพรุ่งนี้", null, null, null, "S64", null, null, null));
        SCENES.put("S64", new SCENE("Narrator", "Day6", "จบ DAY 6", null, null, null, "S65", null, null, null));
