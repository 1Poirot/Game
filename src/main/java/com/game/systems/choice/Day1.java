...
public class Day1 {
    ...
    private void LAYOUT_UI() {
        ...
        if (CHAR_ORIG2 != null && LABEL_CHARACTER2 != null) {
            ...
            // วาง ตัวละครอื่นตรงกลางแนวนอนเช่นกัน
        ...
        BG_VIEW.setComponentZOrder(LABEL_CHARACTER2, 1); // ปรับให้อยู่บน LABEL_CHARACTER
    ...
    private void BUILD_STORY() {
        ...
        SCENES.put("S2", new SCENE("ผู้บรรยาย", "Day1", "เสียงล้อรถบรรทุกขนของค่อย ๆ เงียบลงหน้าบ้านหลังใหม่", null, null, null, "S3", null, null, null));
        SCENES.put("S3", new SCENE("ผู้บรรยาย", "Day1", "บ้านสองชั้นสีครีมในเมืองที่คุณไม่เคยรู้จักมาก่อน", null, null,null, "S4", null, null, null));
        SCENES.put("S4",new SCENE("คุณ", "Day1", "“ต่อจากนี้…ที่นี่คือบ้านของเรา”", null, null, null, "S5", null, null, null));
        SCENES.put("S5", new SCENE("ผู้บรรยาย", "Day1", "คำพูดของผู้ปกครองยังดังอยู่ในหัว", null, null, null, "S6", null, null, null));
        SCENES.put("S6",new SCENE("ผู้บรรยาย", "Day1", "ทุกอย่างเกิดขึ้นเร็วเกินไป—การย้ายงาน การเก็บของ การบอกลาเพื่อน", null,null, null, "S7", null, null, null));
        SCENES.put("S7", new SCENE("ผู้บรรยาย", "Day1", "คุณไม่มีแม้แต่เวลาจะตั้งตัว", null, null, null, "S8", null,null, null));
        ...
        SCENES.put("S14", new SCENE("ผู้บรรยาย", "Day1", "คืนนั้นคุณจัดของเข้าห้องใหม่", null, null, null, "S15", null,null, null));
        SCENES.put("S15",new SCENE("ผู้บรรยาย", "Day1", "บางคนบอกว่าจะคิดถึง", null, null, null, "S16", null, null, null));
        SCENES.put("S16",new SCENE("ผู้บรรยาย", "Day1", "บางคนบอกว่าอย่าลืมกัน", null, null, null, "S17", null, null, null));
        SCENES.put("S17",new SCENE("ผู้บรรยาย", "Day1", "คุณวางโทรศัพท์ลงช้า ๆ", null, null, null, "S18", null, null, null));
        SCENES.put("S18",new SCENE("คุณ", "Day1", "“เริ่มใหม่อีกครั้งสินะ…”", null, null, null, "S19", null, null, null));
        SCENES.put("S19", new SCENE("ผู้บรรยาย", "Day1", "เช้าวันเปิดเทอม", null, null, null, "S20", null, null, null));
        SCENES.put("S20", new SCENE("คุณ", "Day1", "ลมเช้าเย็นกว่าที่คาด", null, null, null, "S21", null, null, null));
        SCENES.put("S21", new SCENE("ผู้บรรยาย", "Day1", "คุณยืนอยู่หน้าประตูโรงเรียนในชุดนักเรียนใหม่เอี่ยม", null,null, null, "S22", null, null, null));
        SCENES.put("S22", new SCENE("ผู้บรรยาย", "Day1", " เสียงนักเรียนรอบตัวเต็มไปด้วยบทสนทนาและเสียงหัวเราะ", null,null, null, "S23", null, null, null));
        SCENES.put("S23", new SCENE("ผู้บรรยาย", "Day1", "แต่ไม่มีเสียงไหนเรียกชื่อคุณ", null, null, null, "S24", null,null, null));
        SCENES.put("S24", new SCENE("ผู้บรรยาย", "Day1", "คุณสูดหายใจลึก", null, null, null, "S25", null, null, null));
        SCENES.put("S25", new SCENE("ผู้บรรยาย", "Day1", "ก้าวเท้าเข้าไปในรั้วโรงเรียน", null, null, null, "S26", null,null, null));
        SCENES.put("S26", new SCENE("ผู้บรรยาย", "Day1", "และทันทีที่คุณเดินผ่านมุมตึกเรียน", null, null, null, "S27",null, null, null));
        SCENES.put("S27", new SCENE("", "Day1", "ปึก!", null, null, null, "S28", null, null, null));
        SCENES.put("S28", new SCENE("ผู้บรรยาย", "Day1", "คุณชนเข้ากับใครบางคนอย่างแรง", null, null, null, "S29", null,null, null));
        SCENES.put("S29", new SCENE("ผู้บรรยาย", "Day1", "หนังสือในมือเขาร่วงกระจายบนพื้น", null, null, null, "S30",null, null, null));
        SCENES.put("S30", new SCENE("ผู้บรรยาย", "Day1", "ดวงตาคู่หนึ่งเงยขึ้นมามองคุณ", null, null, null, "S31", null,null, null));
        SCENES.put("S31", new SCENE("ผู้บรรยาย", "Day1", "แววตานั้นนิ่ง เย็น…แต่มีบางอย่างซ่อนอยู่", null, null, null,"S32", null, null, null));
        SCENES.put("S32", new SCENE("???", "Day1", "“นักเรียนใหม่…?”", null, null, null, "S33", null, null, null));
        SCENES.put("S33",new SCENE("ผู้บรรยาย", "Day1", "น้ำเสียงไม่ได้เย็นชา", null, null, null, "S34", null, null, null));
        ...
        SCENES.put("S42", new SCENE("ผู้บรรยาย", "Day1", "คุณชะงักไปเล็กน้อยก่อนจะดึงมือกลับ", null, null, null, "S43",null, null, null));
        SCENES.put("S43",new SCENE("ผู้บรรยาย", "Day1", "เขาเงยหน้าขึ้นมองคุณ", null, null, null, "S44", null, null, null));
        SCENES.put("S44", new SCENE("ผู้บรรยาย", "Day1", "สายตานิ่ง ๆ แต่ไม่ได้ดูน่ากลัว", null, null, null, "S45",null, null, null));
        SCENES.put("S45", new SCENE("???", "Day1", "“ระวังหน่อย… ตรงนี้คนเดินผ่านเยอะ”", null, null, null, "S46", null,null, null));
        SCENES.put("S46", new SCENE("ผู้บรรยาย", "Day1", "น้ำเสียงเรียบ เหมือนพูดเตือนตามปกติ", null, null, null, "S47",null, null, null));
        SCENES.put("S47", new SCENE("ผู้บรรยาย", "Day1", "ตอนนั้นเองที่คุณนึกขึ้นได้", null, null, null, "S48", null,null, null));
        SCENES.put("S48", new SCENE("ผู้บรรยาย", "Day1", "คนตรงหน้าคือหนึ่งในนักเรียนที่คนอื่นพูดถึงบ่อยในโรงเรียนนี้",null, null, null, "Q1", null, null, null));
        ...
        SCENES.put("Q1_A", new SCENE("คุณ", "Day1", "+ ความประทับใจ (สุภาพ จริงใจ) +5", null, null, null, "S49", null,null, null));
        SCENES.put("Q1_B", new SCENE("คุณ", "Day1", "- เล็กน้อย (ปากไว แต่ดูมั่นใจ) /+2", null, null, null, "S49", null,null, null));
        SCENES.put("Q1_C", new SCENE("คุณ", "Day1", "+ ความอ่อนโยน +1", null, null, null, "S49", null, null, null));

        SCENES.put("S49", new SCENE("ผู้บรรยาย", "Day1", "เขามองคุณอยู่ครู่หนึ่งก่อนจะลุกขึ้นยืน", null, null, null,"S50", null, null, null));
        SCENES.put("S50", new SCENE("ผู้บรรยาย", "Day1", "แล้วส่งหนังสือเล่มสุดท้ายคืนให้", null, null, null, "S51",null, null, null));
        SCENES.put("S51", new SCENE("???", "Day1", "“นักเรียนใหม่สินะ… ห้อง 2-B ใช่ไหม?”", null, null, null, "S52",null, null, null));
        SCENES.put("S52",new SCENE("ผู้บรรยาย", "Day1", "คุณพยักหน้าอย่างแปลกใจ", null, null, null, "S53", null, null, null));
        SCENES.put("S53", new SCENE("คุณ", "Day1", "“รู้ได้ยังไง…?”", null, null, null, "S54", null, null, null));
        SCENES.put("S54",new SCENE("ผู้บรรยาย", "Day1", "ก่อนมองหน้าคุณอีกครั้ง", null, null, null, "S55", null, null, null));
        SCENES.put("S55", new SCENE("ผู้บรรยาย", "Day1", "คุณชะงัก", null, null, null, "S56", null, null, null));
        SCENES.put("S56", new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายมองคุณอยู่ครู่หนึ่ง", null, null, null, "S57", null,null, null));
        SCENES.put("S57", new SCENE("ผู้บรรยาย", "Day1", "เหมือนกำลังประเมินอะไรบางอย่าง", null, null, null, "S58",null, null, null));
        SCENES.put("S58", new SCENE("ผู้บรรยาย", "Day1", "ก่อนตอบสั้น ๆ", null, null, null, "S59", null, null, null));
        SCENES.put("S59", new SCENE("???", "Day1", "“ดูออก”", null, null, null, "S60", null, null, null));
        SCENES.put("S60",new SCENE("ผู้บรรยาย", "Day1", "แล้วเขาก็เดินผ่านคุณไป", null, null, null, "S61", null, null, null));
        SCENES.put("S61",new SCENE("ผู้บรรยาย", "Day1", "แล้วเขาก็เดินผ่านคุณไป", null, null, null, "S62", null, null, null));
        SCENES.put("S62", new SCENE("ผู้บรรยาย", "Day1", "ทิ้งไว้แค่ความรู้สึกแปลก ๆ ในอก", null, null, null, "S63",null, null, null));
        SCENES.put("S63",new SCENE("ผู้บรรยาย", "Day1", "คุณไม่รู้ว่าทำไม", null, null, null, "S64", null, null, null));
        SCENES.put("S64", new SCENE("ผู้บรรยาย", "Day1", "ในห้องเรียน 2-B", null, null, null, "S65", null, null, null));
        SCENES.put("S65", new SCENE("ผู้บรรยาย", "Day1", "ครูประจำชั้นเรียกคุณขึ้นแนะนำตัว", null, null, null, "S66",null, null, null));
        SCENES.put("S66", new SCENE("ผู้บรรยาย", "Day1", "นักเรียนทั้งห้องมองมาที่คุณ", null, null, null, "S67", null,null, null));
        SCENES.put("S67",new SCENE("ผู้บรรยาย", "Day1", "บางคนยิ้ม บางคนกระซิบกัน", null, null, null, "S68", null, null, null));
        SCENES.put("S68",new SCENE("ผู้บรรยาย", "Day1", "หัวใจคุณเต้นแรงอีกครั้ง", null, null, null, "Q2", null, null, null));
        ...
        SCENES.put("Q2_A",new SCENE("คุณ", "Day1", "ได้ภาพลักษณ์เรียบร้อย ", null, null, null, "S69", null, null, null));
        SCENES.put("Q2_B", new SCENE("คุณ", "Day1", "ได้ความสนใจจากหลายคน", null, null, null, "S69", null, null, null));
        SCENES.put("Q2_C",new SCENE("คุณ", "Day1", "บางคนเริ่มสนใจคุณเป็นพิเศษ", null, null, null, "S69", null, null, null));

        SCENES.put("S69", new SCENE("ผู้บรรยาย", "Day1", "ห้องเรียน", null, null, null, "S70", null, null, null));
        SCENES.put("S70",new SCENE("ผู้บรรยาย", "Day1", "หลังแนะนำตัวหน้าห้องเสร็จ", null, null, null, "S71", null, null, null));
        SCENES.put("S71", new SCENE("ผู้บรรยาย", "Day1", "ครูให้คุณไปนั่งที่ว่างด้านหลัง", null, null, null, "S72",null, null, null));
        SCENES.put("S72", new SCENE("ผู้บรรยาย", "Day1", "และเมื่อคุณเดินไปถึงโต๊ะเรียน", null, null, null, "S73", null,null, null));
        SCENES.put("S73",new SCENE("ผู้บรรยาย", "Day1", "คุณหยุดชะงักเล็กน้อย", null, null, null, "S74", null, null, null));
        SCENES.put("S74",new SCENE("ผู้บรรยาย", "Day1", "โลกมันกลมเกินไปหรือเปล่า…", null, null, null, "S75", null, null, null));
        SCENES.put("S75", new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายเหลือบมองคุณนิดเดียว", null, null, null, "S76", null,null, null));
        SCENES.put("S76", new SCENE("???", "Day1", "“บังเอิญอีกแล้ว”", null, null, null, "S77", null, null, null));
        SCENES.put("S77", new SCENE("ผู้บรรยาย", "Day1", "คุณหัวเราะ", null, null, null, "Q3", null, null, null));
        ...
        SCENES.put("Q3_A",new SCENE("คุณ", "Day1", "ความสัมพันธ์ +5 (เขินแรง)", null, null, null, "S117", null, null, null));
        SCENES.put("Q3_B", new SCENE("คุณ", "Day1", "ความสัมพันธ์ +2", null, null, null, "S78", null, null, null));
        SCENES.put("Q3_C", new SCENE("คุณ", "Day1", "ความสัมพันธ์ 0", null, null, null, "S78", null, null, null));
        SCENES.put("S117",new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายยิ้มเล็กน้อย", null, null, null, "S78", null, null, null));

        SCENES.put("S78", new SCENE("ผู้บรรยาย", "Day1", "พักกลางวัน", null, null, null, "S79", null, null, null));
        SCENES.put("S79", new SCENE("ผู้บรรยาย", "Day1", "โรงอาหารเต็มไปด้วยนักเรียนที่มีเพื่อนอยู่แล้ว", null, null,null, "S80", null, null, null));
        SCENES.put("S80", new SCENE("ผู้บรรยาย", "Day1", "คุณยืนลังเลอยู่หน้าโรงอาหาร", null, null, null, "S81", null,null, null));
        SCENES.put("S81",new SCENE("ผู้บรรยาย", "Day1", "ทันใดนั้น คุณหันไป", null, null, null, "S82", null, null, null));
        SCENES.put("S82", new SCENE("???", "Day1", "“ถ้ายังไม่มีที่นั่ง… ไปด้วยกันไหม”", null, null, null, "S83", null,null, null));
        SCENES.put("S83", new SCENE("ผู้บรรยาย", "Day1", "คุณแอบแปลกใจเล็กน้อย เพราะอีกฝ่ายดูเป็นคนไม่ค่อยชวนใคร", null, null, null, "Q4", null, null, null));
        ...
        SCENES.put("Q4_A", new SCENE("คุณ", "Day1", "ความสัมพันธ์ +3", null, null, null, "S84", null, null, null));
        SCENES.put("Q4_B", new SCENE("คุณ", "Day1", "ความสัมพันธ์ -1", null, null, null, "S84", null, null, null));
        SCENES.put("Q4_C",
                new SCENE("คุณ", "Day1", "ความสัมพันธ์ +1 (ขำ ๆ)", null, null, null, "S84", null, null, null));

        SCENES.put("S84", new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายพยักหน้าเบา ๆ แล้วเดินนำไป", null, null, null, "S85",null, null, null));
        SCENES.put("S85", new SCENE("ผู้บรรยาย", "Day1", "ระหว่างกินข้าว", null, null, null, "S86", null, null, null));
        SCENES.put("S86",new SCENE("ผู้บรรยาย", "Day1", "บทสนทนาส่วนใหญ่เงียบ", null, null, null, "S87", null, null, null));
        SCENES.put("S87",new SCENE("ผู้บรรยาย", "Day1", "จนคุณเป็นฝ่ายถามก่อน", null, null, null, "S88", null, null, null));
        SCENES.put("S88", new SCENE("คุณ", "Day1", "“นาย ชื่ออะไรเหรอ”", null, null, null, "S89", null, null, null));
        SCENES.put("S89",new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายมองคุณครู่หนึ่ง", null, null, null, "S90", null, null, null));
        SCENES.put("S90", new SCENE("ผู้บรรยาย", "Day1", "เหมือนกำลังตัดสินใจว่าจะตอบไหม", null, null, null, "S91",null, null, null));
        SCENES.put("S91", new SCENE("ผู้บรรยาย", "Day1", "ก่อนพูดว่า", null, null, null, "S92", null, null, null));
        SCENES.put("S92", new SCENE("คิมแจฮยอน (Kim Jaehyun)", "Day1", "คิมแจฮยอน (Kim Jaehyun)", null, null, null,"S93", null, null, null));
        SCENES.put("S93", new SCENE("คิมแจฮยอน (Kim Jaehyun)", "Day1", "“แล้ว เธอ ล่ะ”", null, null, null, "S94", null,null, null));
        SCENES.put("S94",new SCENE("ผู้บรรยาย", "Day1", "คุณบอกชื่อตัวเอง", null, null, null, "S95", null, null, null));
        SCENES.put("S95", new SCENE("คิมแจฮยอน (Kim Jaehyun)", "Day1", "“ชื่อเข้ากับ เธอ ดี”", null, null, null, "S96",null, null, null));
        SCENES.put("S96", new SCENE("ผู้บรรยาย", "Day1", "คำพูดธรรมดา", null, null, null, "S97", null, null, null));
        SCENES.put("S97", new SCENE("ผู้บรรยาย", "Day1", "แต่หัวใจคุณกลับเต้นแรงอย่างประหลาด", null, null, null, "S98",null, null, null));
        SCENES.put("S98", new SCENE("ผู้บรรยาย", "Day1", "หลังเลิกเรียน", null, null, null, "S99", null, null, null));
        SCENES.put("S99", new SCENE("ผู้บรรยาย", "Day1", "คุณเก็บของเสร็จช้ากว่าคนอื่น", null, null, null, "S100", null,null, null));
        SCENES.put("S100", new SCENE("ผู้บรรยาย", "Day1", "เมื่อเดินออกมาหน้าโรงเรียน", null, null, null, "S101", null,null, null));
        SCENES.put("S101", new SCENE("ผู้บรรยาย", "Day1", "คุณเห็นอีกฝ่ายยืนอยู่ใต้ต้นไม้ใหญ่", null, null, null,"S102", null, null, null));
        SCENES.put("S102", new SCENE("ผู้บรรยาย", "Day1", "ลมเย็นพัดผ่าน ใบไม้ไหวเบา ๆ", null, null, null, "S103", null,null, null));
        SCENES.put("S103",new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายหันมาเห็นคุณพอดี", null, null, null, "S104", null, null, null));
        SCENES.put("S104", new SCENE("คิมแจฮยอน (Kim Jaehyun)", "Day1", "“วันแรกเป็นยังไงบ้าง”", null, null, null,"S105", null, null, null));
        SCENES.put("S105",new SCENE("ผู้บรรยาย", "Day1", "คุณคิดอยู่ครู่หนึ่งก่อนตอบ", null, null, null, "Q5", null, null, null));

        SCENES.put("Q5", new SCENE("คุณ", "Day1", "คำถามที่ 5 — สถานะ",
                "A) “เหนื่อยนิดหน่อย… แต่ดีขึ้นเพราะนาย”",
        ...
        SCENES.put("S108", new SCENE("คุณ", "Day1", "“นายใจดีจังนะ”", null, null, null, "S109", null, null, null));
        SCENES.put("S109",new SCENE("ผู้บรรยาย", "Day1", "อีกฝ่ายหลุดยิ้มบาง ๆ", null, null, null, "S110", null, null, null));
        SCENES.put("S110", new SCENE("ผู้บรรยาย", "Day1", "รอยยิ้มที่ทำให้บรรยากาศรอบตัวเปลี่ยนไปทันที", null, null,null, "S111", null, null, null));
        SCENES.put("S111", new SCENE("คิมแจฮยอน (Kim Jaehyun)", "Day1", "“ไม่ได้ใจดี… แค่ไม่อยากเห็นเธอหลงทาง”", null,null, null, "S112", null, null, null));
        SCENES.put("S112", new SCENE("ผู้บรรยาย", "Day1", "หัวใจคุณเต้นแรงขึ้นอีกครั้ง", null, null, null, "S113", null,null, null));
        SCENES.put("S113",new SCENE("ผู้บรรยาย", "Day1", "และคุณเพิ่งรู้ตัวว่า—", null, null, null, "S114", null, null, null));
        SCENES.put("S114", new SCENE("ผู้บรรยาย", "Day1", "ความรู้สึกโดดเดี่ยวที่มีมาตลอดทั้งวัน", null, null, null,"S115", null, null, null));
        SCENES.put("S115", new SCENE("ผู้บรรยาย", "Day1", "มันหายไปตั้งแต่ตอนไหนก็ไม่รู้", null, null, null, "END",null, null, null));
    ...
    private void SHOW_SCENE(String ID) {
        ...
        if (sceneNumber >= 1 && sceneNumber <= 7) {
            ...
            BG_VIEW.SET_BG("src/main/resources/images/backgrounds/บ้าน.png");
        } else if (sceneNumber >= 14 && sceneNumber <= 18) {
            ...
            BG_VIEW.SET_BG("src/main/resources/images/backgrounds/ห้องเรียน.jpg");
        } else if ((sceneNumber >= 78 && sceneNumber <= 97) || ID.startsWith("Q4")) {
        ...
        } else if (sceneNumber >= 106 && sceneNumber <= 115) {
            BG_VIEW.SET_BG("src/main/resources/images/backgrounds/โรงเรียนตอนเย็น.jpg");
        }
    ...
    private void GOTO_NEXT_BY_CLICK() {
        ...
        if (CURRENT_ID.equals("END")) {
            // ส่งหน้าต่าง (FRAME) เดิมไปให้ Day2 จัดการต่อ
            new Day2().CREATEANDSHOWGUI(FRAME);
            return;
        }
