...
if (BTN_SETTINGS != null) {
    ...
    private void STYLE_CHOICE_BUTTON(JButton B) {
        ...
        SCENES.put("S8", new SCENE("ผู้บรรยาย", "Day1", "คุณยืนมองป้ายชื่อโรงเรียนที่พรุ่งนี้ต้องเข้าไปเรียน", null, null, null, "S9", null, null, null));
        ...
        SCENES.put("S53", new SCENE("???", "Day1", "“รู้ได้ยังไง…?”", null, null, null, "S54", null, null, null));
        ...
        SCENES.put("Q4_C", new SCENE("คุณ", "Day1", "ความสัมพันธ์ +1 (ขำ ๆ)", null, null, null, "S84", null, null, null));
   ...
   private void PICK(int INDEX) {
    ...
    if (CURRENT_ID.equals("Q2")) {
        if (INDEX == 1) affection.addAffection(CharacterRoute.KIM_JAEHYUN, 1);
